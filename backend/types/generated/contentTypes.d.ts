...
export interface ApiCardCard extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    publishedAt: Schema.Attribute.DateTime;
    quest_text: Schema.Attribute.Text;
    slug: Schema.Attribute.UID & Schema.Attribute.Required;
    symbol_seed: Schema.Attribute.String;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiCategoryCategory extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    fragments: Schema.Attribute.Relation<
      'manyToMany',
...
export interface ApiDifficultyDifficulty extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    slug: Schema.Attribute.UID<'level'>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiFragmentFragment extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    slot: Schema.Attribute.Enumeration<['action', 'place', 'object']>;
...
export interface ApiPostPost extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    attached_card: Schema.Attribute.Relation<'oneToOne', 'api::card.card'>;
    author: Schema.Attribute.Relation<
      'manyToOne',
      'plugin::users-permissions.user'
    >;
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    downvoted_by: Schema.Attribute.Relation<
      'manyToMany',
      'plugin::users-permissions.user'
    >;
    ...
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    upvoted_by: Schema.Attribute.Relation<
      'manyToMany',
      'plugin::users-permissions.user'
    >;
    votes: Schema.Attribute.BigInteger;
  };
}
