        ...
        <main className="relative min-h-screen flex flex-col items-center text-[#3c2415] px-6 py-12">
            ...
            <div className="relative z-10 w-full max-w-4xl bg-[#fff9eb] border-2 border-[#d2a06f] rounded-xl p-6 md:p-12 shadow-[0_6px_0_#c99063,0_14px_24px_rgba(0,0,0,0.18)]">
                ...
                <div className="prose prose-stone max-w-none text-[#5e4632]">
                    ...
                    <p>
                        1.1. Настоящее Пользовательское соглашение (далее — Соглашение) относится к сайту «Questly», расположенному по адресу https://quest.cdmerch.ru.
                    </p>
                    <p>
                    ...
                    <ul>
                        <li>
                            <strong>Questly</strong> — Интернет-ресурс, расположенный на доменном имени https://quest.cdmerch.ru, осуществляющий свою деятельность посредством Интернет-ресурса и сопутствующих ему сервисов.
                        </li>
                        <li>
